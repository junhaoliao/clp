...
const PRESTO_SEARCH_STATE_DEFAULT = Object.freeze({
    ...
    errorMsg: null as Nullable<string>,
    errorName: null as Nullable<string>,
    orderBy: "",
    queryDrawerOpen: false,
    select: "*",
    sqlInterface: PRESTO_SQL_INTERFACE.GUIDED,
    timestampKey: null as Nullable<string>,
    where: "",
});
...
export {
    PRESTO_SEARCH_STATE_DEFAULT, PRESTO_SQL_INTERFACE,
};
