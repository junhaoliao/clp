    ...
    return (
        <div className="space-y-5 max-w-lg">
                ...
                <textarea
                    ...
                    onChange={(e) => {
                        ...
                        if (val) {
                            ...
                            setDashboard(rest as Dashboard);
                        }
                    }}/>
            </div>
            ...
            <div>
                ...
                <div className="mt-1 text-sm text-muted-foreground font-mono">{dashboard.uid}</div>
            </div>

            <div>
                <label className="text-xs text-muted-foreground">Version</label>
                <div className="mt-1 text-sm text-muted-foreground">{dashboard.version}</div>
            </div>

            <div>
                <label className="text-xs text-muted-foreground">Created</label>
                <div className="mt-1 text-sm text-muted-foreground">{dashboard.createdAt}</div>
            </div>

            <div>
                <label className="text-xs text-muted-foreground">Updated</label>
                <div className="mt-1 text-sm text-muted-foreground">{dashboard.updatedAt}</div>
            </div>
...
function DangerZone({uid}: {uid: string}) {
